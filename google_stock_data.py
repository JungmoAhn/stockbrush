...
class GoogleStockData(object):
    ...
    def get_json_obj_fr_file(self):
        ...
        try :
            ...
            print('its failed to load a json file. you need to check internet connection')
    ...
    def get_screener_data(self):
        print('getting google stock data..')
        ...
        print('downloading json from ' + self.target_full_url)
